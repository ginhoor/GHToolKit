...
//  GHLocationKit
//
//  Created by 大帅 on 2022/9/19.
//

import Foundation

public struct SFSymbolsIcon { }

public extension SFSymbolsIcon {
    ...
    static let importFiles = UIImage(systemName: "square.and.arrow.down.on.square")
    static let importFilesFill = UIImage(systemName: "square.and.arrow.down.on.square.fill")
